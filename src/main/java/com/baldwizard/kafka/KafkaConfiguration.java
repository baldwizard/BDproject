...
public class KafkaConfiguration {
    ...
    public static final String TOPIC = "moj-topic";
    //public static final String TOPIC_OUT = "";
    ...
    public static Properties createConsumerConfig() {
        ...
        consumerConfig.put(ConsumerConfig.GROUP_ID_CONFIG, "moja-grupa");
